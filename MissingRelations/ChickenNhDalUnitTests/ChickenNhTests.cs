...
namespace ChickenNhDalUnitTests;
...
public class Tests
{
    ...
    public static Configuration ConfigureNHibernate()
    {
        ...
        {
            x.ConnectionString = "Server=(localdb)\\mssqllocaldb;Database=ChickenDb;Trusted_Connection=True;";
        ...
        cfg.AddAssembly("ChickenNhDal"); // Referenz zur Assembly mit den POCOs und dem Mapping
