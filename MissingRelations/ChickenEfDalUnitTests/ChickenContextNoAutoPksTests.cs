using ChickenEfDal.ModelNoAutoPks;
using Microsoft.EntityFrameworkCore;

namespace ChickenEfDalUnitTests;

public class ChickenContextNoAutoPksTests
{
    [Test]
    ...
    {
        string connection = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=ChickenDbNoAutoPks;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";
